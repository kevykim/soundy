      ...
      {showModal && (
        <Modal onClose={() => setShowModal(false)}>
            ...
            <div className="w-96 h-48 flex flex-col justify-evenly items-center p-2">
                <h1 className="text-md font-bold text-red-500">Are you sure you want to delete this playlist?</h1>
                <div className="text-sm underline underline-offset-4">{playlistName}</div>
                <div className="mt-2">
